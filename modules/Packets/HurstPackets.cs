...
{
    class NetOdysseyHurstPacketsModule : 
		  NetOdysseyModuleBase, INetOdysseyPacketAnalyzerModule
    {
        ...
        public override string ModuleStart()
        {
            ...
            Console.WriteLine("Hurst _Ks=[{0}] (total:{1}) started", 
							  _Kstring , _Kcount);
            return "";
        }
											  ...
											  int WindowSize)
        {
            ...
            // We assume that the whole analysis window is full 
